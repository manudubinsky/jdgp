...
public class SurfaceFlattenerOld {
	...
	public SurfaceFlattenerOld(PolygonMesh mesh) throws Exception {
		_mesh = mesh;
		_graph = mesh._graph;
		translateEdges();
	}
...
*/
	...
	*/
	  ...
	  public static void main(String[] args) {
		  ...
		  try {
			SurfaceFlattenerOld  pm = new SurfaceFlattenerOld(new PolygonMesh(coord, coordIndex));
			pm.flatten(10, 0.01f);
/*			
			for (int i = 0; i < 6; i++) {
