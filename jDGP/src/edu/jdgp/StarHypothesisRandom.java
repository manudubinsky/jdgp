...
public class StarHypothesisRandom {
	Graph _tree;
	int _starRoot;
	VecInt _parent;
	...
	public StarHypothesisRandom(int nV, int K) {
		_nV = nV;
		_K = K;
	}
	...
	public void process() throws Exception {
		...
		// Generar el arbol
			...
			//g.dump();
		// Agregar la raiz de la estrella y conectarla al arbol
	...
	// probar grafos de 50, 100 y 200 nodos
	// 400 100 * 3
	// 200 5000 * 3
	// 100 10000 * 3
	// 50  100000 * 3
	...
	public static void main(String[] args) {
		...
		int nV = 400;
		try {
			StarHypothesisRandom sh = new StarHypothesisRandom(nV, K);
			sh.process();
		} catch (Exception e) {
