...
import edu.jdgp.SpanningTreesMatsuiCollector.Collector;
import edu.jdgp.SpanningTreesMatsuiCollector.MaxZerosTrees;
import edu.jdgp.SpanningTreesMatsuiProcessor.Processor;
import edu.jdgp.SpanningTreesMatsuiProcessor.TreeListProcessor;
...
/*
	public static void main(String[] args) throws Exception {
		...
		LABILogger log = new LABILogger("/home/manuel/20170817/doctorado/octave/tesis-octave/ejemplos/connected-graphs/stats/deg-" + nodeCnt + "/deg-" + nodeCnt + "-maxZeros.csv");
